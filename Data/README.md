...
The following directories are data sets of Job Scheduling Problems. The included files are dictionaries. Their items are the data from states whose amount of remaining Jobs and Machines defines the assigned key.<br>
