...
The following directories define data sets of Job Scheduling Problems. The included files are dictionaries whose keys are the 2-tuples (<i>n_state</i>, <i>m_state</i>). The assigned lists consist of the data of states with <i>n_state</i> remaining Jobs and <i>m_state</i> active Machines.<br>
