...
- [LSTM_Data.ipynb](https://github.com/Dieguinho1612/Job-Scheduling-Deep-Reinforcement-Learning/blob/main/Notebooks/LSTM_Data.ipynb): By running this Notebook and selecting a directory corresponding to a data set, all included dictionaries get merged and the immanent data transformed to be compatible with our Neural Network.
