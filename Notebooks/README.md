...
- [LSTM_Data.ipynb](https://github.com/Dieguinho1612/Job-Scheduling-Deep-Reinforcement-Learning/blob/main/Notebooks/LSTM_Data.ipynb): Merges and transforms all saved data dictionaries from a directory into a form compatible with our Neural Network. Whenever a data set is created, this Notebook has to be rerun from the start and the respective directory has to be selected.
